...
storiesOf('Basic(Array)', module)
  ...
  .add('simple', () => {
    const data = createPersonDataArray(5);
    return (
      <MuiVirtualizedTable
        data={data}
  ...
  .add('composite cells', () => {
    const data = createPersonDataArray(1000);
    return (
  ...
  .add('text overflow', () => {
    const data = createPersonDataArray(10);
    return (
      <MuiVirtualizedTable
        data={data}
        columns={[
  ...
  .add('pagination', () => {
    const data = createPersonDataArray(100);
    return (
      <AutoSizer>
        {({ width, height }) => (
          <PaginatedTable
...
storiesOf('Column widths(Array)', module)
...
storiesOf('maxHeight(Array)', module)
  .add('basic', () => {
    const data = createPersonDataArray(100);
    return (
      <AutoSizer>
  ...
  .add('pagination', () => {
    const data = createPersonDataArray(15);
    return (
      <AutoSizer>
        {({ width, height }) => (
          <PaginatedTable
...
storiesOf('Selected(Array)', module)
  .add('basic', () => {
    const data = createDessertData();
    return (
...
storiesOf('Performance(Array)', module)
...
storiesOf('Resizable Columns(Array)', module).add('Simple table', () => {
  const data = createPersonDataArray(1000);
  return (
    <div style={{ height: 'calc(100vh)' }}>
      <AutoSizer>
...
storiesOf('Examples(Array)', module)
  .add('dessert', () => {
    const data = createDessertData();
    return (
      <div style={{ height: 'calc(100vh)' }}>
